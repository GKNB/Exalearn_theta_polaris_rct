...
CMD_SIM="python /grand/CSC249ADCD08/twang/real_work_polaris_gpu/mpi_sweep_hdf5_multi_sym_polaris.py ${config_root_dir}/configs_phase${phase_idx}/config_1001460_cubic.txt"
#CMD_SIM="python /grand/CSC249ADCD08/twang/real_work_polaris_gpu/mpi_sweep_hdf5_multi_sym_polaris.py ${config_root_dir}/configs_phase${phase_idx}/config_1522004_trigonal_part1.txt"
#CMD_SIM="python /grand/CSC249ADCD08/twang/real_work_polaris_gpu/mpi_sweep_hdf5_multi_sym_polaris.py ${config_root_dir}/configs_phase${phase_idx}/config_1531431_tetragonal.txt"
echo ${CMD_SIM}
