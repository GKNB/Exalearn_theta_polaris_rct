...
active_learning_sleep_time_in_seconds=60
...
sim_file=log_parallelwf_sim_${num_epoch}_epoch_data_70m_node_${num_node}_phase_${num_phase}_v1
ml_file=log_parallelwf_ml_${num_epoch}_epoch_data_70m_node_${num_node}_phase_${num_phase}_v1
al_file=log_parallelwf_al_${num_epoch}_epoch_data_70m_node_${num_node}_phase_${num_phase}_v1
