...
sim_file=log_parallelwf_sim_${num_epoch}_epoch_data_550m_node_${num_node}_phase_${num_phase}_topo_2_v1
ml_file=log_parallelwf_ml_${num_epoch}_epoch_data_550m_node_${num_node}_phase_${num_phase}_topo_2_v1
al_file=log_parallelwf_al_${num_epoch}_epoch_data_550m_node_${num_node}_phase_${num_phase}_topo_2_v1
