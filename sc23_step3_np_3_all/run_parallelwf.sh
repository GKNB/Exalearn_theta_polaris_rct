...
sim_file=log_parallelwf_sim_${num_epoch}_epoch_data_230m_node_${num_node}_phase_${num_phase}_v3
ml_file=log_parallelwf_ml_${num_epoch}_epoch_data_230m_node_${num_node}_phase_${num_phase}_v3
al_file=log_parallelwf_al_${num_epoch}_epoch_data_230m_node_${num_node}_phase_${num_phase}_v3
